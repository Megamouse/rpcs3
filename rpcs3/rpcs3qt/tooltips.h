...
public:
	...
	const struct settings
	{
		...
		const QString rb3_guitar        = tr("Rock Band 3 Guitar controller support.\nSelect 1 or 2 controllers if the game requires RB3 Guitar controllers and you don't have real guitar controllers.\nSelect Null if the game has support for DualShock or if you have real guitar controllers.\nA real guitar controller can be used at the same time as an emulated guitar controller.");
