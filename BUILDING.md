...
**Either add the** `QTDIR` **environment variable, e.g.** `<QtInstallFolder>\6.4.2\msvc2019_64\` **, or use the [Visual Studio Qt Plugin](https://marketplace.visualstudio.com/items?itemName=TheQtCompany.QtVisualStudioTools2019)**
...
2) Add the path to your Qt installation with compiler e.g. `<QtInstallFolder>\6.4.2\msvc2019_64`, version will fill in automatically.
